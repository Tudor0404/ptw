import { AlgebraicValue, DateTimeRange, ParsedNumericValue, UserDateTimeInput } from '../types';

export function checkAlgebraic(expr: AlgebraicValue) {
  return (
...
export function createMilitaryTimeString(t: number): string {
  if (t < 0 || t > 86399999 || !Number.isInteger(t)) return 'null';
