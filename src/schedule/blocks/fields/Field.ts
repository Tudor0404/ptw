import { DateTimeRange, IBlock, IField, ISchedule, MergeState, ParsedNumericValue, Result } from '../../../types';
...
import { EvaluationError, IndexOutOfBoundsError, ValidationError } from '../../../errors';
...
export default abstract class Field<V> implements IField<V> {
  ...
  protected getActiveParsedNumberic(values: ParsedNumericValue[]): boolean[] {
    const activeDays = Array(this.maxValue).fill(false);
